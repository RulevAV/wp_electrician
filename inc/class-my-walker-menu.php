...
class My_Walker_Menu extends Walker_Nav_Menu
{
    ...
    public function start_lvl(&$output, $depth = 0, $args = null)
    {
        ...
        // Default class.
        $classes = array('dropdown-menu dropdown-menu-end animate slideIn');
    ...
    public function start_el(&$output, $data_object, $depth = 0, $args = null, $current_object_id = 0)
    {
        ...
        if ($this->has_children && 0 === $depth) {
            $atts['class'] = 'nav-link d-flex justify-content-center dropdown-toggle ' . $active_class;
            $atts['href'] = '#';
            ...
            if ($depth > 0) {
                ...
                $atts['class'] = 'nav-link d-flex justify-content-center ' . $active_class;
            }
        }
